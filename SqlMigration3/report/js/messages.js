...
var collapsimage = "img/expander_arrow_down.gif";
...
function toggle(elem) {
    ...
    if ($(elem).hasClass("tablePlusIcons")) {
        $(elem).parent().find('table').hide();
        $(elem).removeClass('tablePlusIcons').addClass('tableMinusIcons').attr('src', plusMG);
    } else if ($(elem).hasClass("tableMinusIcons")) {
        $(elem).parent().find('table').show();
        $(elem).removeClass('tableMinusIcons').addClass('tablePlusIcons').attr('src', minusIMG);
    }
}
