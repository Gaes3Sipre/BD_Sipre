...
function toggleBookmark(s) {
    ...
    if (document.getElementsByClassName) {
        elems = document.getElementsByClassName("idbookmark");
    } else {
    ...
    Bookmark = new CreateBookmarksObject(elems);
        //Bookmark = new CreateBookmarksObject(s);
        var testLen = Bookmark.getLength();
...
function SetClearBookMarks1() {
    try {
        ...
        else { window.external.EnableClearBookMarks(); }
    }
    catch (e) {
    }
